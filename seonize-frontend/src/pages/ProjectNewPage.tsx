    ...
    <div className="project-new-page">
      <div className="project-new-container">
        <div className="project-new-header">
          ...
          <p className="project-new-subtitle">從關鍵字分析結果創建新專案，自動帶入分析數據</p>
        </div>

        <form onSubmit={handleSubmit} className="project-new-form">
          {message && <div className="form-message form-message--error">{message}</div>}
          {/* 基本信息 */}
            ...
            <div className="form-section">
              ...
              <div className="analysis-preview">
                ...
                <div className="analysis-item">
                  ...
                  <span className="analysis-value">{selectedStyle || '未選擇'}</span>
                </div>
              ...
              <div className="form-group">
                <Select
                  ...
                  options={
                    projectData.title_suggestions?.map((suggestion) => ({
