...
| `PEXELS_API_KEY` | Pexels 圖庫 API Key | ➖ | `...` |
| `PIXABAY_API_KEY` | Pixabay 圖庫 API Key | ➖ | `...` |
...
---
> [!WARNING]
> **圖片功能環境變數 (Image System)**：
> 若要使用 Pexels 或 Pixabay 圖庫搜尋功能，請務必在 Zeabur 後台新增 `PEXELS_API_KEY` 或 `PIXABAY_API_KEY` 環境變數。
